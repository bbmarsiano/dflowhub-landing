...
function DashboardMockup() {
  return (
    <svg viewBox="0 0 520 380" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <rect x="232" y="124" width="42" height="4" rx="2" fill="var(--brand-faint)"/>
      ...
      <text x="432" y="100" fontFamily="system-ui" fontSize="7" fill="var(--brand-muted)">Задачи</text>
      ...
      <rect x="132" y="172" width="11" height="30" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="145" y="172" width="11" height="22" rx="2" fill="var(--brand-faint)"/>
      <rect x="162" y="172" width="11" height="45" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="175" y="172" width="11" height="35" rx="2" fill="var(--brand-faint)"/>
      <rect x="192" y="172" width="11" height="38" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="205" y="172" width="11" height="28" rx="2" fill="var(--brand-faint)"/>
      <rect x="222" y="172" width="11" height="55" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="235" y="172" width="11" height="40" rx="2" fill="var(--brand-faint)"/>
      <rect x="252" y="172" width="11" height="42" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="265" y="172" width="11" height="32" rx="2" fill="var(--brand-faint)"/>
      <rect x="282" y="172" width="11" height="60" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="295" y="172" width="11" height="48" rx="2" fill="var(--brand-faint)"/>
      <rect x="312" y="172" width="11" height="48" rx="2" fill="var(--brand-color)" opacity="0.7"/>
      <rect x="325" y="172" width="11" height="36" rx="2" fill="var(--brand-faint)"/>
      ...
      <circle cx="390" cy="180" r="3" fill="var(--brand-faint)"/>
      <circle cx="390" cy="180" r="1.5" fill="var(--brand-color)"/>
      ...
      <circle cx="390" cy="202" r="3" fill="var(--brand-faint)"/>
      <circle cx="390" cy="202" r="1.5" fill="var(--brand-color)"/>
      ...
      <circle cx="390" cy="224" r="3" fill="var(--brand-faint)"/>
      <circle cx="390" cy="224" r="1.5" fill="var(--brand-color)"/>
      ...
      <circle cx="390" cy="246" r="3" fill="var(--brand-faint)"/>
      <circle cx="390" cy="246" r="1.5" fill="var(--brand-color)"/>
